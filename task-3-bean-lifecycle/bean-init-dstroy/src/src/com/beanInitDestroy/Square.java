...
public class Square implements Shape{
    ...
    public void setDatabaseOperations(DatabaseOperations databaseOperations){this.databaseOperations=databaseOperations;}

    @Override
    public void storeShape(){
        databaseOperations.storeShapeIntoDatabase("Square");
    }
    @Override
    public void draw2D() {
